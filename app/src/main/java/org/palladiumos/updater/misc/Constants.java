/*
 * Copyright (C) 2017-2023 Palladium-OS
 *
...
public final class Constants {
    ...
    public static final String PROP_BUILD_DATE = "ro.palladium.build.datetime";
    public static final String PROP_BUILD_VERSION = "ro.palladium.base.version";
    ...
    public static final String PROP_ZIP_TYPE = "ro.palladium.ziptype";
