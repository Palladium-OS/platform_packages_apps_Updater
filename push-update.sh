...
updates_dir=/data/palladium_updates
...
adb shell "killall org.palladiumos.updater 2>/dev/null"
adb shell "sqlite3 /data/data/org.palladiumos.updater/databases/updates.db" \
